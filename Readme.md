...
**Windows**: [Download Simple_to_PDF](https://github.com/hollowchest13/Simple_to_PDF/releases/download/v1.0.2/Simple_to_PDF.zip)

**Linux**: [Download Simple_to_PDF](https://github.com/hollowchest13/Simple_to_PDF/releases/download/v1.0.2/Simple_to_PDF.tar.gz)
