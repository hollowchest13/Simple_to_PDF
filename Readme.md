...
**Windows**: [Download Simple_to_PDF](https://github.com/hollowchest13/Simple_to_PDF/releases/latest/download/simple_to_pdf-windows.zip)

**Linux**: [Download Simple_to_PDF](https://github.com/hollowchest13/Simple_to_PDF/releases/latest/download/simple_to_pdf-linux.tar.gz)
