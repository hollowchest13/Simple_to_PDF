...
class ListControlsFrame(BaseFrame):
    ...
    def init_btns(self, *, callbacks: dict[str, Callable]) -> dict[str, tk.Widget]:
        ...
        settings_btn:dict[str, tk.Widget]=self._build_settings_panel(callbacks=callbacks)
    ...
    self, *, callbacks: dict[str, Callable]
        ...
        button_configs = [
            {"id": "btn_add",    "text": "Add files", "cmd": callbacks["add"],"icon_name":"add_btn.png"},
            {"id": "btn_up",     "text": "Move up",  "cmd": lambda: callbacks["move"](direction="up",),"icon_name":"up_btn.png"},
            {"id": "btn_down",   "text": "Move down",  "cmd": lambda: callbacks["move"](direction="down"),"icon_name":"down_btn.png"},
            {"id": "btn_remove", "text": "Remove",  "cmd": callbacks["remove"],"icon_name":"remove_btn.png"},
        ]
    ...
    def _build_action_panel(
        ...
        button_configs = [
            {"id": "btn_merge",        "text": "Merge files",        "cmd": callbacks["merge"],"icon_name":"merge_btn.png"},
            {"id": "btn_extract",      "text": "Extract pages",      "cmd": callbacks["extract"],"icon_name":"extract_btn.png"},
            {"id": "btn_status_clear", "text": "Clear console", "cmd": callbacks["clear_status"],"icon_name":"clean_btn.png"},
        ]
    ...
    self, *, callbacks: dict[str, Callable]
        ...
        button_configs = [
            ...
            {"id": "btn_help",      "text": "Help",      "cmd": callbacks["help"],"icon_name":"help_btn.png"},
            {"id": "btn_settings",      "text": "Settings",      "cmd": callbacks["settings"],"icon_name":"settings_btn.png"},
        ]
        return self._buttons_pack(btns_config=button_configs,parent=self.settings_frame)